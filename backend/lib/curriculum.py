...
MODULES: dict[str, dict[str, Any]] = {
    ...
    "networking": {
        ...
        "promise": "Start with curiosity, not a pitch. The goal is another conversation.",
        "duration_min": 6,
        "objectives": [
            "Open a conversation with a stranger without it feeling transactional",
            "Read whether someone actually wants to engage",
            "Use the right kind of icebreaker for the situation",
            "Move from small talk into business without pitching",
            "Create a specific reason to follow up, then exit politely",
        ],
        "why_it_matters": "Networking is not selling — it is deciding whether there is a reason to talk again. People at events have their guard up precisely because someone always tries to sell them something. The rep who is genuinely curious gets remembered; the rep who pitches gets avoided for the rest of the day.",
        "when_used": "Conferences, trade shows, association meetings, referral introductions, community events, and any first face-to-face contact where nobody has an agenda yet.",
        "terms": [
            {"term": "Icebreaker", "definition": "A low-stakes opening that makes it easy for the other person to respond. It should cost them nothing to answer."},
            {"term": "Situational opener", "definition": "Using something happening around you both — the venue, the queue, the session that just ended."},
            {"term": "Event-based opener", "definition": "Asking what brought them here, or what they made of something on the agenda."},
            {"term": "Professional opener", "definition": "Asking about their role, company, industry or what they're working on right now."},
            {"term": "Observation-based opener", "definition": "A genuine, specific observation — never flattery, never a compliment on appearance."},
            {"term": "Common ground", "definition": "The shared reference point that makes a follow-up feel natural rather than cold."},
            {"term": "Reason to follow up", "definition": "A specific, useful thing you will send or do — not 'let's stay in touch'."},
        ],
        "framework": {
            "name": "Approach → Icebreaker → Curiosity → Common ground → Reason to follow up → Exit",
            "steps": [
                {"label": "Approach", "detail": "Read the room. Open body language, no cornering, no clipboard energy."},
                {"label": "Icebreaker", "detail": "Situational, event-based, professional or observational — match it to where you are."},
                {"label": "Curiosity", "detail": "Ask about them and follow the answer. Two questions on one thread beats six on six."},
                {"label": "Common ground", "detail": "Name what you have in common; that's what makes the follow-up warm."},
                {"label": "Reason to follow up", "detail": "Offer something specific and useful, then exchange details."},
                {"label": "Exit", "detail": "Leave while it's still going well. Thank them, be memorable, move on."},
            ],
        },
        "examples": [
            {
                "weak": "Hi! Do you have a minute? I work for Rota Systems — we do workforce scheduling for healthcare providers, and I think we could probably save your organisation a lot of money. Do you handle scheduling where you are?",
                "strong": "Hi — I'm Alex. That last session ran twenty minutes over, didn't it? Did you get anything out of it, or was it a bit theoretical for you?",
                "why": "The weak version turns a coffee break into a sales call and the answer is always 'we're fine'. The strong version is a shared situation, easy to answer, and gives her a reason to keep talking.",
            },
            {
                "weak": "So what do you do? … Right. And how big is the company? … And who handles scheduling? … And what's your budget cycle?",
                "strong": "You said you've opened two new sites this year — what does that actually do to your day-to-day? I'd imagine the operational side gets messy fast.",
                "why": "Rapid-fire questions become an interrogation and people shut down. The strong version follows one thread with genuine interest, which is how people reveal real problems.",
            },
            {
                "weak": "Great chatting — here's my card, give me a shout if you ever want to talk about scheduling.",
                "strong": "I'll send you that operations benchmark I mentioned — it covers the multi-site problem you described. What's the best email? And if it's useful, would a proper conversation in a couple of weeks be worth it?",
                "why": "A card with no reason attached goes in a bin. The strong version leaves with a specific deliverable, a captured contact and a soft, dated next step.",
            },
        ],
        "mistakes": [
            "Pitching within the first minute",
            "Interrogating instead of conversing",
            "Talking about yourself before asking anything",
            "Failing to catch or use their name",
            "Overstaying — the conversation dies rather than ends",
            "Leaving with 'let's stay in touch' and nothing concrete",
        ],
        "strong_performance": [
            "You opened with something situational rather than a pitch",
            "You asked follow-up questions on the same thread",
            "You learned what they do before describing what you do",
            "You found genuine common ground",
            "You left with a specific reason to follow up and their contact details",
        ],
        "knowledge_check": [
            {
                "question": "What is the objective of a networking conversation?",
                "options": ["Close a deal", "Deliver your value proposition", "Earn another conversation", "Collect as many cards as possible"],
                "answer": 2,
                "explanation": "Networking sells the next conversation. Anything more, at an event, reads as a pitch and gets you avoided.",
            },
            {
                "question": "Which icebreaker fits best at a conference coffee break?",
                "options": [
                    "Do you handle purchasing at your company?",
                    "What did you make of that last session?",
                    "Can I tell you what we do?",
                    "How much do you currently spend on this?",
                ],
                "answer": 1,
                "explanation": "An event-based opener costs nothing to answer and signals you are a peer, not a vendor.",
            },
        ],
        "focus_categories": ["Rapport", "Question Quality", "Active Listening", "Opening", "Next Steps"],
        "graded_principles": [
            "Opened with curiosity rather than a pitch",
            "Asked follow-up questions on the same thread instead of interrogating",
            "Learned about them before describing what you do",
            "Established genuine common ground",
            "Created a specific reason to follow up and secured contact details",
        ],
    },
    "phone-sales": {
